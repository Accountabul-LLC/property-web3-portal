...
const STATIC_ROUTES: Record<string, RouteMeta> = {
  ...
  '/operations/doe': { title: `DOE Operations | ${SITE_NAME}`, description: 'Daily operating expense worksheet for Accountabul property operations.', noindex: true },
  '/legal/privacy': { title: `Privacy Policy | ${SITE_NAME}`, description: 'Global privacy policy for Accountabul websites, apps, and connected property portal services.' },
  '/legal/terms': { title: `Terms of Service | ${SITE_NAME}`, description: 'Accountabul terms of service for portal accounts, marketplace activity, payments, and acceptable use.' },
  '/legal/compliance': { title: `Compliance Packet | ${SITE_NAME}`, description: 'Accountabul compliance packet with data declarations, release checks, regional notices, and IP clearance.' },
  '/legal/security': { title: `Security Notice | ${SITE_NAME}`, description: 'Security notice for Accountabul identity, wallet, payment, and operating controls.' },
