...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      attach_payment_provider_artifacts: {
        Args: {
          p_destination_address?: string | null
          p_destination_tag?: number | null
          p_invoice_payload?: Json
          p_payment_id: string
          p_payment_payload?: Json
          p_payment_uri?: string | null
          p_provider: string
          p_provider_checkout_url?: string | null
          p_provider_client_secret?: string | null
      ...
      invoice_status_for_payment_status: {
      ...
      payment_status_allows_transition: {
