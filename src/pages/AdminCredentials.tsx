 ...
 *
 * Three-panel admin view for the Phase 1A credential issuer system:
 *   1. IssuerWalletPanel  — testnet issuer status, seed check, registration
 *   2. PendingRegistrationsPanel — wallet registration approval queue
 *   3. CredentialLedgerPanel — full credential lifecycle view with issue/revoke actions
 */
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Manage XRPL credential issuance, wallet registrations, and trading access
            </p>
          </div>
        </div>
